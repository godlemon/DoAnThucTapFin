...
namespace DoAnThucTapFin.Areas.Admin.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.products);
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,Productid,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
            ...
            ViewData["Productid"] = new SelectList(_context.products, "Id", "Brand", orderDetail.Productid);
            return View(orderDetail);
        }
